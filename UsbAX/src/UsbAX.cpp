...
void UsbAX::begin(const char *stream, speed_t baud)
{
...
void UsbAX::disconnect()
{
    close(uart0_filestream);
    printf("DISCONNECTED!!! \n");
}

int UsbAX::reset(unsigned char ID)
{
...
int UsbAX::ping(unsigned char ID)
{
    memset(tx_buffer, 0, sizeof(tx_buffer) );
...
int UsbAX::setID(unsigned char ID, unsigned char newID)
{
    memset(tx_buffer, 0, sizeof(tx_buffer) );
...
int UsbAX::setBD(unsigned char ID, long baud)
{
...
int UsbAX::move(unsigned char ID, int Position)
{
...
int UsbAX::moveSpeed(unsigned char ID, int Position, int Speed)
{
...
int UsbAX::moveDeg(unsigned char ID, int Degrees)
{
	int Position;
...
int UsbAX::moveSpeedDeg(unsigned char ID, int Degrees, int Speed)
{
	int Position;
...
int UsbAX::setEndless(unsigned char ID,bool Status)
{
...
int UsbAX::turn(unsigned char ID, bool SIDE, int Speed)
{
...
int UsbAX::moveRW(unsigned char ID, int Position)
{
...
int UsbAX::moveSpeedRW(unsigned char ID, int Position, int Speed)
{
...
int UsbAX::torqueStatus( unsigned char ID, bool Status)
{
...
int UsbAX::ledStatus( unsigned char ID, bool Status)
{
...
int UsbAX::setTempLimit(unsigned char ID, unsigned char Temperature)
{
...
int UsbAX::setVoltageLimit(unsigned char ID, unsigned char DVoltage, unsigned char UVoltage)
{
...
int UsbAX::setAngleLimit(unsigned char ID, int CWLimit, int CCWLimit)
{
...
int UsbAX::setMaxTorque(unsigned char ID, int MaxTorque)
{
...
int UsbAX::setSRL(unsigned char ID, unsigned char SRL)
{
...
int UsbAX::setRDT(unsigned char ID, unsigned char RDT)
{
...
int UsbAX::setLEDAlarm(unsigned char ID, unsigned char LEDAlarm)
{
...
int UsbAX::setShutdownAlarm(unsigned char ID, unsigned char SALARM)
{
...
int UsbAX::setCMargin(unsigned char ID, unsigned char CWCMargin, unsigned char CCWCMargin)
{
...
int UsbAX::setCSlope(unsigned char ID, unsigned char CWCSlope, unsigned char CCWCSlope)
{
...
int UsbAX::setPunch(unsigned char ID, int Punch)
{
...
int UsbAX::moving(unsigned char ID)
{
...
int UsbAX::lockRegister(unsigned char ID)
{
...
int UsbAX::RWStatus(unsigned char ID)
{
...
int UsbAX::readTemperature(unsigned char ID)
{
...
int UsbAX::readVoltage(unsigned char ID)
{
...
int UsbAX::readPosition(unsigned char ID)
{
...
int UsbAX::readSpeed(unsigned char ID)
{
...
int UsbAX::readLoad(unsigned char ID)
{
